...
class OnboardingData {
  static final List<OnboardingPageModel> pagesContent = [
    OnboardingPageModel(
      ...
      description:
          "Your personal companion for monitoring daily meal intake and water consumption to maintain a healthy lifestyle.",
    ),
    OnboardingPageModel(
      ...
      description:
          "Easily log your meals and track your daily meal consumption to reach your health goals.",
    ),
    OnboardingPageModel(
      title: "Stay Hydrated",
